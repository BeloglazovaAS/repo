...
+ Произвёл замену с помощью редактора VIM  
`Ctrl+\, lu, enter, s21, enter`  
![](images/7-10.png)

+ Произвёл замену с помощью редактора NANO  
`f7`  
![](images/7-11.png)

+ Произвёл замену с помощью редактора MCEDIT  
`f4`  
![](images/7-12.png)
...
![](images/14-1.png)
+ Открыл для просмотра `/var/log/syslog`  
![](images/14-2.png)
+ Открыл для просмотра `/var/log/auth.log`  
![](images/14-3.png)
